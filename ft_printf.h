...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/01 15:00:26 by joaomigu          #+#    #+#             */
/*   Updated: 2024/06/01 15:00:26 by joaomigu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*get_formatted_string(t_info *info,
						char *content, va_list *args);
...
void				i_number_tobuffer(int nbr, char *base,
						int bf_size, char *bf);
void				l_number_tobuffer(long nbr, char *base,
						int bf_size, char *bf);
...
char				*x_handler(t_info *info, va_list *args,
						char c);
char				*x_get_string_number(t_info *info,
						unsigned int nbr, char *base, char c);
